...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('LUM_Comment', 'LUM_Comment_commentid_LUM_Comment_has_LUM_Entity_commentid', array(
             'name' => 'LUM_Comment_commentid_LUM_Comment_has_LUM_Entity_commentid',
             'local' => 'commentid',
             'foreign' => 'commentid',
             'foreignTable' => 'LUM_Comment_has_LUM_Entity',
             ));
        $this->createForeignKey('LUM_Comment_has_LUM_Entity', 'LUM_Comment_has_LUM_Entity_commentid_LUM_Comment_commentid', array(
             'name' => 'LUM_Comment_has_LUM_Entity_commentid_LUM_Comment_commentid',
             'local' => 'commentid',
             'foreign' => 'commentid',
             'foreignTable' => 'LUM_Comment',
             ));
    ...
    {
        $this->dropForeignKey('LUM_Comment', 'LUM_Comment_commentid_LUM_Comment_has_LUM_Entity_commentid');
        $this->dropForeignKey('LUM_Comment_has_LUM_Entity', 'LUM_Comment_has_LUM_Entity_commentid_LUM_Comment_commentid');
